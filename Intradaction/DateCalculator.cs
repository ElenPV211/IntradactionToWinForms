...
namespace Intradaction
{
    public partial class DateCalculator : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "End date cannot be less then start date", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
          ...
          int months = endDate.Month- startDate.Month;
                ...
                if (months != 0) result += months.ToString()+(months==1?"month":"months");
                if (result != ""&&months!=0) result += ", ";
